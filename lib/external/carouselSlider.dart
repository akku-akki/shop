...
class CarouselSlider extends StatefulWidget {
  CarouselSlider({
    ...
    this.indicatorEnableColor: Colors.black87,
    this.indicatorDisableColor: Colors.black38,
  })  : this.realPage =
  ...
  final Color indicatorEnableColor;
  final Color indicatorDisableColor;
      ...
      children: <Widget>[
        getWrapper(PageView.builder(
          ...
          onPageChanged: (int index) {
            ...
            if (widget.showIndicator) setState(() {});
          },
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: currentPage == index
                        ? widget.indicatorEnableColor
                        : widget.indicatorDisableColor),
              );
            }).toList(),
          )
      ],
